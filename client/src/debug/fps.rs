...
pub fn fps_gui(mut egui_context: EguiContexts, diagnostics: Res<Diagnostics>) {
...
pub fn team_swap_gui(mut egui_context: EguiContexts, mut client: ResMut<RenetClient>) {
